...
exports.getAllSportPersons = async (req, res) => {
    try {
        ...
        const data = rows.map(item => ({
            ...item,
            image_red: item.image_red ? `http://54.254.162.138:10000/uploads/${item.image_red}` : null,
            image_blue: item.image_blue ? `http://54.254.162.138:10000/uploads/${item.image_blue}` : null
        }));
